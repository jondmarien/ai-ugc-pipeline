    ...
    >
      <div className="mx-auto max-w-[var(--max)]" data-reveal-group>
        <div className="mb-14 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          >
            The color tells you the angle before you read a word. Chosen per
            post from the content itself, never to chase a feeling.
          </p>
        </div>
          ...
          {PILLARS.map((p) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(120% 80% at 0% 0%, ${p.hex}22, transparent 60%)`,
                }}
              />

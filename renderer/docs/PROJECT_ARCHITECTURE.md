...
| **Design tokens** | `renderer/src/design/tokens.ts` | `palette`, `pillarAccent`, 5-way `themes` (offensive/defensive/hacking/purple-team/ai), `BRAND_STYLE`, `overlays` (readability scrim). |

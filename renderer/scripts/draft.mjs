...
const THEMES = ["offensive", "defensive", "hacking", "purple", "ai"];
...
function die(msg) {
  ...
  console.error(`\nFlags:`);
  console.error(`  --theme=offensive|defensive|hacking|purple|ai   brand theme (red / blue / green / purple-team-purple / AI-orange; default from pillar)`);

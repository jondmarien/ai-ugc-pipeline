...
# individual steps:
bun run new        -- 2026-06-13 my-topic model_security --theme=defensive --captions=highlight   # scaffold a blank post (themes: offensive/defensive/hacking/purple-team/ai)

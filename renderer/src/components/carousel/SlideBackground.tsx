    ...
    >
        ...
        <>
          ...
          {usesImage && (
            <img
              ...
              alt=""
              data-bg-image
              style={{ ...cover, opacity: artOpacity }}
            />
          )}
        </>
      ) : usesImage ? (
        ...
        <>
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: `radial-gradient(140% 120% at 50% 0%, #0a1322 0%, ${palette.bg} 55%, ${palette.bgDeep} 100%)`,
            }}
          />
      ...
      <div
        style={{
          ...
          backdropFilter:
            usesImage && overlays.ambientBlurPx > 0
              ? `blur(${overlays.ambientBlurPx}px)`
              : undefined,

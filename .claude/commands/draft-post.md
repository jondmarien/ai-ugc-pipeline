...
argument-hint: <idea> | <pillar> [| captions=…] [| theme=offensive|defensive|hacking] [| voice=voxcpm2|voxcpm2-0.5b|http|none]   e.g. logs into chatbots | data_leakage | captions=highlight | theme=hacking | voice=voxcpm2

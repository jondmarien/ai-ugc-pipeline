# Ingested posts — index

One line per ingest. New ingests are written by the `ig-ingest` skill (`/ingest-post <url>`); legacy ingests live flat in `pipeline/content/INGESTED_*.md`.
...
- [INGESTED_CAROUSEL_POSTING_SCHEDULE.md](../INGESTED_CAROUSEL_POSTING_SCHEDULE.md) — posting-time windows from @_techy.boy.
- [INGESTED_REEL_INSTAGRAM_GROWTH.md](../INGESTED_REEL_INSTAGRAM_GROWTH.md) — reel transcript + claim tagging from Mikhail Gribov.
